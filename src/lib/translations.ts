...
export const translations = {
  ru: {
    ...
    telegramFormatHint: 'Формат: @никнейм, латиница, цифры и _, без пробелов, 5–32 символа после @',
    telegramPlaceholderAt: '@username',
    instagramPlaceholderFlexible: 'Никнейм или ссылка на профиль',
    phonePlaceholderFlexible: 'Только цифры, можно + в начале',
    telegram_too_short: 'После @ — от 5 до 32 символов',
    ...
    telegram_must_start_at: 'Укажите ник с символа @ в начале',
    telegram_spaces: 'Не используйте пробелы',
    instagramFormatHint: 'Никнейм или полная ссылка на профиль Instagram',
    ...
    instagram_invalid_input: 'Введите корректный ник или ссылку на профиль Instagram',
  ...
  en: {
    ...
    telegramFormatHint: 'Format: @username — Latin letters, digits, _, no spaces, 5–32 chars after @',
    telegramPlaceholderAt: '@username',
    instagramPlaceholderFlexible: 'Username or profile link',
    phonePlaceholderFlexible: 'Digits only, optional + at the start',
    telegram_too_short: 'After @ — 5 to 32 characters',
    ...
    telegram_must_start_at: 'Start the username with @',
    telegram_spaces: 'Do not use spaces',
    instagramFormatHint: 'Username or full Instagram profile URL',
    ...
    instagram_invalid_input: 'Enter a valid username or Instagram profile link',
