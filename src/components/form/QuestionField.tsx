...
export const QuestionField: React.FC<QuestionFieldProps> = ({
  ...
  const getContextualOtherLabel = (qId: string) => {
      ...
      {showOtherField && (
        <div className="mt-2">
          ...
          <textarea
            ...
            placeholder={question.id === 'weight_satisfaction' && !getContextualOtherLabel('weight_satisfaction')
